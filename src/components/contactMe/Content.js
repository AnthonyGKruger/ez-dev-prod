...
const ContactMeContent = () => {
	...
	const onSubmitHandler = (event) => {
		...
		if (
			...
			// Send the email using the emailjs-com package
			emailjs
				.send(
					"ezdev_smtp_service",
					"ezdev_contact_me",
	...
	const inputContainerClasses =
		"flex items-center p-2 border border-primary-blue dark:border-primary-gold focus:border-primary-gold dark:focus:border-lighter-gold rounded-md";
