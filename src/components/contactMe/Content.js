            ...
            <div className={`py-20 grid grid-cols-2 lg:grid-cols-4 w-11/12 mx-auto`}>
                ...
                <div className={`col-span-2 lg:pr-24`}>
                    ...
                    <div className="mt-5 flex flex-wrap items-center gap-4 text-sm 2xl:text-xl sm:text-base  ">
                        ...
                        >
                            <AiFillLinkedin
                                className="hover:text-primary-gold transition-all text-5xl text-primary-blue duration-500 dark:text-white dark:hover:text-primary-gold"/>
                        </Link>
                        ...
                        <Link target="_blank" href="tel:+27610340820">
                            <BsPhoneFill
                                className="hover:text-primary-gold transition-all text-4xl text-primary-blue duration-500 dark:text-white dark:hover:text-primary-gold"/>
                        </Link>
                        <Link target="_blank" href="mailto:anthony@ezdev.solutions">
                            <HiMail
                                className="hover:text-primary-gold transition-all text-6xl text-primary-blue duration-500 dark:text-white dark:hover:text-primary-gold"/>
                        </Link>
                    </div>
