...
const Hero = () => {
	...
	return (
		<section className="lg:py-20 pt-10 pb-9 bg-alternative-blue">
			<div className="container px-6 m-auto">
					...
					<div className="col-span-4 ">
						...
						>
							...
							>
								...
								<div className="pt-9">
									<button className="w-full md:w-auto hover:scale-105 mx-auto text-center  border-2 border-alternative-gold hover:border-primary-gold rounded-full px-5 py-4  pointer bg-light-gold hover:bg-white text-alternative-blue hover:text-alternative-gold duration-300">
										<Link
											href="/contact-me"
											className="font-bold text-xl tracking-wide "
										>
