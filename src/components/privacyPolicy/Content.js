...
const PrivacyPolicyContent = () => {
  return (
    <article className="max-w-2xl mx-auto px-5 py-9">
      ...
      <p  id="use" className="text-xl font-semibold">I use your information to:</p>
      <ul className="list-disc pl-8 mb-6">
      ...
      <p  id="cookies" className="text-xl font-semibold">Cookies</p>
      <p className=" mb-6">
      ...
      <p  id="other" className="text-xl font-semibold">Other websites</p>
      <p className=" mb-6">
      ...
      <p id="review"  className="text-xl font-semibold">Changes to my privacy policy</p>
      <p className=" mb-6">
      ...
      <p  id="contact" className="text-xl font-semibold">How to contact me</p>
      <p className=" mb-6">
