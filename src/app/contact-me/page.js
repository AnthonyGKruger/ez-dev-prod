...
const ContactMe = () => {
	...
	return (
		<>
			{contactFormState.error && <WarningBanner />}
					...
					<article className={""}>
						...
						>
							...
							{!contactFormState.mailSending && (
								<div className="mt-3">
									<input
										className={` mx-auto text-center font-black border-2 border-alternative-gold hover:border-primary-blue rounded-xl px-5 py-3  pointer bg-primary-blue hover:bg-white text-[#f1d6b0] hover:text-primary-blue transition-all duration-500"`}
										type="submit"
										value="Send"
									/>
								</div>
